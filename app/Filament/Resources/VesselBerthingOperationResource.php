...
{
    protected static ?string $model = VesselBerthingOperation::class;
    ...
    {
        return [
            'index' => Pages\ListVesselBerthingOperations::route('/'),
            'create' => Pages\CreateVesselBerthingOperation::route('/create'),
