...
{
    protected static ?string $model = WarehouseHardRoofCovered::class;
    ...
    {
        return [
            'index' => Pages\ListWarehouseHardRoofCovereds::route('/'),
            'create' => Pages\CreateWarehouseHardRoofCovered::route('/create'),
